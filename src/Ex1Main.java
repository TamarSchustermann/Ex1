...
public class Ex1Main {
    public static void main(String[] args) {
        ...
        while (!num1.equals("quit") && !num2.equals("quit")) {
            ...
            System.out.println("num1= " + num1 + " is number: true , value: ");
            { else System.out.println("ERR: num1 is in the wrong format! (" + num1 + ")");
            }
        ...
        while (!num1.equals("quit") && !num2.equals("quit")) {
            ...
            { else System.out.println("ERR: num2 is in the wrong format! (" + num2 + ")");
            }
            System.out.println("num2= " + num2 + "is number: true , value: ");
